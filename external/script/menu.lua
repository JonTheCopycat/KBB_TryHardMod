...
--Kamekaze hold down/up to scroll vars
local holdval ={0,0}
local hlen = 6
...
function menu.f_commandlistRender(section, t)
	...
	--Kamekaze hold down/up to scroll variable iteration
	if  main.f_input(main.t_players, {'holdup'}) then
		holdval[0]=holdval[0]+1
		else
		holdval[0]=0
		end
	
		if  main.f_input(main.t_players, {'holddown'}) then
		holdval[1]=holdval[1]+1
		else
		holdval[1]=0
		end
