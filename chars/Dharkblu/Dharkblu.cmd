...
triggerall = stateno != 900 && stateno != [610,615]
trigger1 = 1
y = 6
...
value = 360
triggerall = map(HasSword) = 0
triggerall = stateno = 100 || prevstateno = 100 || command = "FF"
Triggerall = statetype != A
trigger1 = ctrl && command = "b"
;trigger2 = (stateno = 350 && time <= 1)
;---------------------------------------------------------------------------
; Down + B
[State -1, Down + B]
type = ChangeState
